...
export default function Drodpdown({ id, postUserId, feed, page, setConfirmed, postedOn }: any) {
            ...
            <Menu as="div" className="relative inline-block text-left">
                ...
                <Transition
                    ...
                    <Menu.Items className="origin-top-right absolute right-0 pt-[5px]  z-10 pb-[5px]  w-56 rounded-md shadow-lg bg-[#1f1f2d] ring-1 ring-black ring-opacity-5 focus:outline-none">
                        <div className="py-1">
                            {user && user?.userId && user?.userId === postUserId && (
                                <Menu.Item>
                                    ...
                                    <div className="cursor-pointer">
                                        <a
                                            ...
                                            <span className="pl-[14px] text-[16px] font-Proxima-SemiBold">
                                                Delete post
                                            </span>
                                        </a>
                                    </div>
                            ...
                            {user && user?.userId && user?.userId === postedOn && (
                                <Menu.Item>
                                    {/* <Link legacyBehavior href={`/feed/${id}`}> */}
                                    <div className="cursor-pointer">
                                        <a
