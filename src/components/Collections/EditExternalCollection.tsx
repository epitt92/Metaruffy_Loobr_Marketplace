...
import { editCollection, editExtCollection } from '../../redux/collections/actions';
import Poups from '../popup/poups';

const EditExternalCollection = ({ setstate, hide, data }: any) => {
    ...
    const handleSubmit = (e: React.ChangeEvent<HTMLFormElement>) => {
        ...
        if (values.videoUrl && !urlRegex.test(values.videoUrl)) {
            ...
            dispatch(editExtCollection(collection._id, data11, handleCloseModal, data?.fetchCollection));
        }
    };
        ...
        <div className=" sm:w-auto w-[450px] xs:w-full m-auto rounded-lg px-8 py-6">
            <form onSubmit={handleSubmit}>
                ...
                <p className="xl:text-lg mt-5">
                    <span className="text-white">Description</span> (Optional)
                </p>
...
export default EditExternalCollection;
