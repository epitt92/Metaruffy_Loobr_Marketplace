    ...
    return (
        <>
            {/* view for auditorium owner */}
            {
                ...
                //                             <i
                //                                 className={`icon-video ${true ? 'AtActive' : ''}`}
                //                                 onClick={() =>
                //                                     state.isVideoDisable ? enableVideoLocalUser() : muteVideoLocalUser()
                //                                 }></i>
                //                         </div>
                //                     </li>
                //                     <li>
                //                         <div className="AtControlsIcon">
                //                             <i
                //                                 className={`icon-audio ${false ? 'AtActive' : ''}`}
                //                                 onClick={() =>
                //                                     state.isAudioDisable ? enableAudioLocalUser() : muteAudioLocalUser()
                //                                 }></i>
                //                         </div>
                //                     </li>
                //                 </ul>
