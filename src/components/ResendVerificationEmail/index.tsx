...
export const ResendVerificationEmail = ({ setstate, state }: any) => {
    ...
    const handleSubmit = (e: React.ChangeEvent<HTMLFormElement>) => {
        ...
        dispatch(resendVerificationEmail(data, setstate));
    };

    return (
        <div className="w-full md:w-[30rem] sm:w-[594px]  m-auto rounded-lg">
            <div className=" border-b border-[#2B2B35] py-6 text-center">
                <h2 className="text-xl text-white">Resend Verification Email</h2>
            </div>
            <div className="pt-6 px-8 pb-8">
                <form onSubmit={handleSubmit}>
                    {/* <h3 className="text-2rem text-white mb-2">Forgot Your Password?</h3>
