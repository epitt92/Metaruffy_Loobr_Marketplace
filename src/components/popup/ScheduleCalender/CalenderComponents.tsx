  ...
  return (
    <div>
      <div className="flex items-center">
        <h2 className="flex-auto font-semibold text-xl lg:text-3xl text-white">January 2022</h2>
        <button
          type="button"
      ...
      <div className="mt-2 grid grid-cols-7 text-sm">
        {days.map((day, dayIdx) => (
          <div key={day.date} className={classNames(dayIdx > 6 && 'py-2', 'py-2')}>
            <button
              type="button"
              className={classNames(
                ...
                day.isSelected && !day.isToday && 'bg-themecolor text-black' ,
                !day.isSelected && 'hover:bg-gray-200 hover:text-black',
