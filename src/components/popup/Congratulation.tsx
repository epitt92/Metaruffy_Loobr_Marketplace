...
const Congratulation = ({ setstate }: any) => {
  useEffect(() => {
    setTimeout(() => {
      setstate(1);
    }, 2000);
  ...
  return (
    <div className="pt-14 pb-8 px-20 flex justify-center flex-col items-center ">
      ...
      <h2 className="mt-4 font-Circular-Bold text-white">Congratulations!</h2>
      <h5 className=" font-Circular-Book mt-2">Password successfully reset</h5>
