...
const ReportUser = ({ user, setState }: any) => {
    ...
    return (
        <div className="sm:w-[37.5rem] xs:w-full rounded-2xl">
            <h3 className="border-b border-[rgba(255,255,255,0.10)] py-6 px-8 text-white text-center">Report User</h3>
            <div className="p-5">
                ...
                <div className="relative">
                    <textarea
                        ...
                        className="bg-transparent braek border border-[#29303a] text-white rounded-[8px] w-full resize-none h-[155px] p-4 focus:outline-none"></textarea>
                </div>
