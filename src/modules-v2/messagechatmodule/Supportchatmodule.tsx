...
import SingleMessage from '../../components/Chat/components/messageText';
...
const SupportMessages = ({ setClose }: IProps) => {
    ...
    const messageHanlder = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (message.trim() == '' && !file) {
            ...
            try {
                ...
                let res = await dispatch(sendMessage(body, setConfirm, () => {}));
                sentMessage();
    ...
    return (
        <div className="  shadow-2xl  z-30 flex flex-row-reverse gap-5  h-[110vh] lg:hidden block  ">
            <div className="bg-[#14141F]   hover:bg-[#1c1c27]  border-blue1  mt rounded-lg    relative w-full   ">
                <div className="cursor-pointer bg-[#2B2B35] rounded-t-lg  fixed top-26 z-10 w-full  px-9 text-center py-2.5 flex justify-between items-center">
                    <div className="flex items-center w-80">
                        <>
                            ...
                            <div className="ml-2">
                                <p className="text-base text-white braek">Support</p>
                            </div>
                        </>
                    </div>
                ...
                <div
                    className=" px-9  hover:bg-[#1c1c27]  relative duration-300 AtScroll overflow-hidden  "
                    role="presentation">
                    <div
                        className="h-[90vh] overflow-y-auto scrolHide scrollbarHide w-full py-20 flex at-sidebarwrapper flex-col-reverse justify-start"
                                                                  ...
                                                                  <div className="flex flex-row-reverse items-center mt-2">
                                                                      {el?.body && (
                                                                          <div className="flex flex-col">
                                                                              <p className="text-[#14141F] mt-1 bg-[#F1C94A] relative ml-2 px-4 py-4 pl-[25px]  round-yellow Atmymessage  font-Proxima-Regular text-lg braek">
                                                                                  {el?.body && (
                                                              ...
                                                              <div className="inline-block ">
                                                                  ...
                                                                  <div className="flex items-start mt-2 justify">
                                                                      ...
                                                                      <div className="flex flex-col">
                                                                          {el?.body && (
                                                                              <div>
                                                                                  <p className="text-white text-lg  Atothermessage px-4 py-4 bg-[#43434C]  roundedchat  braek pr-[25px]">
                                                                                      {/* {DoEncrypt(el?.body)} */}
                                                                                      {el?.type == 'text' &&
                                                                                          el?.body && (
                                                                                              <SingleMessage
                            ...
                            <form
                                ...
                                <div
                                    ...
                                    <label className="relative cursor-pointer">
                                        ...
                                        />
                                        <div className="h-[28px] w-[28px] font-Proxima-Bold text-xl mb-2  text-themecolor rounded-full bg-[#43434C] flex ml-2 justify-center items-center">
                                            <svg
                                                width="29"
                                                height="29"
                                                viewBox="0 0 29 29"
                                    ...
                                    <div className="relative pl-2 pr-[35px]   w-full ">
                                        {/* {data1?.type == 'PRIVATE' && ( */}
                                        <div className="relative ">
                                            <TextArea
                                                ...
                                                className="px-6 pr-[45px] pl-[12px] h-[45px] py-3 placeholder:text-sm placeholder:text-[#89898F]  !rounded-[10px]"
                                                placeholder={
                                                    isDragActive ? 'Drop the files here ...' : 'Type your message'
                                                }
                                            />
                                        </div>

                                        <p
                                            className="text-white w-[22px] h-[22px]  bg-transparent rounded-full flex items-center justify-center cursor-pointer  border-l-[#2B2B35] text-sm font-Proxima-Regular absolute right-0 bottom-0 pb-6"
                                            onClick={(e: any) => {
                                                !loadinUpload && messageHanlder(e);
                                            }}>
                                            {' '}
                ...
                {statepop && (
                    <Popups show={popup} hide={setPopup} state={statepop} data={dataa} setstate={setstatepop} />
                )}
            </div>
        </div>
    );
