...
export default function Profiledropdown({ id, onDelete }: { id: string; onDelete: Function }) {
                                ...
                                {({ active }: any) => (
                                    <Link legacyBehavior href="">
                                        <a
                                            ...
                                            <h6 className="ml-3 text-basic font-Circular-Book">Edit</h6>
                                        </a>
                                    </Link>
                                )}
                            </Menu.Item>
                                ...
                                {({ active }: any) => (
                                    <Link legacyBehavior href="">
                                        <a
                                            ...
                                            <h6 className="ml-3 text-basic font-Circular-Book">Delete</h6>
                                        </a>
                                    </Link>
                                )}
                            </Menu.Item>
