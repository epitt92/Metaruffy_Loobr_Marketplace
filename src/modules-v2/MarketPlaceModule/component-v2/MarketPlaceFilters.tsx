...
import { GlobalSearch } from '../../../components-v2/header/GlobalSearch';
    ...
    return (
        <>
            <div className="relative mt-8 mb-8 xl:mt-0 ">
                ...
                <Input
                    className="hidden text-white border-2 border-[#2B2B35] hover:border-[#b9b9bf] !rounded-full text-xl pl-[1.813rem] py-5 placeholder:text-xl "
                    placeholder="Search"
                    styles="  "
                    name="search"
                    // value={search}
