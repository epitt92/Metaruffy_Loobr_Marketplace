    ...
    <div className="px-1">
      ...
      >
        {({ open }) => (
          <>
            <Disclosure.Button
              className={`${btnStyle}  w-full flex justify-between  border-b border-[#5C5C63] items-center `}
            >
              {
                propertyicon ? <div className="flex gap-3 items-center">
                  ...
                  <h3 className=" text-[#7D7D8E] text-sm font-Proxima-Bold"> {heading}</h3>
                  ...
                  <h3 className=" text-[#7D7D8E] text-sm font-Proxima-Bold"> {heading}</h3>
                </div> : <h3 className=" text-[#727279] text-sm font-Proxima-Bold"> {heading}</h3>}
              <i
                className={classNames(
                  open
                    ? `rotate-0 ${iconStyle} `
                    : "'${iconStyle} -rotate-180 '",
                  "transform text-sm text-[#727279] transition duration-400 borders rounded-md   "
                )}
                aria-hidden="true"
              >
                <svg
            ...
            <Disclosure.Panel as="dd" className="mt-2.5 w-full  ">
              {children}
            </Disclosure.Panel>
          </>
        )}
