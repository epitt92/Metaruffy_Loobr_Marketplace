...
const TrendingTable = ({ collections, selectedBlockchain }: any) => {
                        ...
                        <table className="min-w-full  divide-y divide-[#2B2B35]">
                            <thead className="">
                                <tr>
                                    ...
                                    <th scope="col" className="hidden AtOrderTableHead w-[13%] ">
                                    ...
                                    <th scope="col" className="AtOrderTableHead  w-[13%]">
                                        <span className="flex justify-end"> Vol. 1d%</span>
                                    </th>
                                    <th scope="col" className="AtOrderTableHead  w-[13%]">
                                ...
                                {collections &&
                                    collections?.map((item: any) => (
                                        <tr
                                            ...
                                            <td className="hidden flex justify-end  text-right AtOrderTableItems   ">
                                                <span className="flex gap-2 items-center  ">
                                            ...
                                            <td
                                                className={`${
                                                    item?.volume_1d < 0 ? 'AtOrderTableItems3 ' : 'AtOrderTableItems2'
                                                } flex items-center gap-1 mt-2`}>
                                                <span className="flex justify-end w-full   text-right  ">
                                                    <span className="flex gap-1 items-center">
                                                        {item?.volume_1d < 0 ? (
                                            ...
                                            <td
                                                className={`${
                                                    item?.volume_7d < 0 ? 'AtOrderTableItems3' : 'AtOrderTableItems2'
                                                }`}>
                                                <span className="flex justify-end w-full  text-right  ">
                                                    <span className="flex gap-1 items-center">
                                                        {item?.volume_7d < 0 ? (
